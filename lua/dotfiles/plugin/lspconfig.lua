local _2afile_2a = "/Users/fankainang/.config/nvim/fnl/dotfiles/plugin/lspconfig.fnl"
local _0_
do
  local name_0_ = "dotfiles.plugin.lspconfig"
  local module_0_
  do
...
local function _3_()
  do end ((require("lspconfig")).gopls).setup({})
