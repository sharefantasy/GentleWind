local _2afile_2a = "/Users/fankainang/.config/nvim/fnl/dotfiles/plugin/better-default.fnl"
local _0_
do
  local name_0_ = "dotfiles.plugin.better-default"
  local module_0_
  do
...
local _2amodule_name_2a = "dotfiles.plugin.better-default"
