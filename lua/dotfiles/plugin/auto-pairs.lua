local _2afile_2a = "/Users/fankainang/.config/nvim/fnl/dotfiles/plugin/auto-pairs.fnl"
local _0_
do
...
local function _3_()
  return nvim.ex.autocmd("FileType", "clojure,fennel,scheme,emacslisp", "lua require('dotfiles.plugin.auto-pairs').init()")
end
