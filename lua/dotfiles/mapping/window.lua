local _2afile_2a = "/Users/fankainang/.config/nvim/fnl/dotfiles/mapping/window.fnl"
local _0_
do
  ...
  do
    ...
    if ("table" == type(x_0_)) then
      ...
      module_0_ = __fnl_global__require_2dmacros
    end
  end
...
local function _2_(...)
  ...
  if ok_3f_0_ then
    _0_["aniseed/local-fns"] = {autoload = {core = "aniseed.core", nu = "aniseed.nvim.util", nvim = "aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
